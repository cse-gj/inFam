...
import com.sample.infam.model.ChildModel;
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FirebaseAuth.getInstance()
                        ...
                        .addOnCompleteListener(ChildSignUp.this, new OnCompleteListener<AuthResult>() {
                            @Override
                            public void onComplete(@NonNull Task<AuthResult> task) { //회원가입 완료시
                                ...
                                FirebaseStorage.getInstance().getReference().child("userImages").child(uid).putFile(imageUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                                    ...
                                    public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                                        ...
                                        ChildModel chiModel = new ChildModel();
                                        chiModel.ChildName = name.getText().toString();
                                        chiModel.profileImageUrlc = imageUrl.getResult().toString();

                                        FirebaseDatabase.getInstance().getReference().child("childrenId").child(uid).setValue(chiModel);
